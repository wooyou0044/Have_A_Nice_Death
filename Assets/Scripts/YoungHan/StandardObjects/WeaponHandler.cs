...
public class WeaponHandler : MonoBehaviour
{
    ...
    public bool TryRelease(Player player, Weapon.Attack attack, Action<GameObject, Vector2, Transform> action1, Action<Strike, Strike.Area, GameObject> action2, Func<Projectile, Projectile> func)
    {
        return false;
    }
